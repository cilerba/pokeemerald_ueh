...
extern const u8 gText_CraftQuantityHave[];
extern const u8 gText_CraftQuantityNeed[];
extern const u8 gText_CraftWhat[];
extern const u8 gText_CraftConfirm[];
extern const u8 gText_CraftCancel[];
extern const u8 gText_CraftFail[];
