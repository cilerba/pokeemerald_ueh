...
#define FLAG_SAID_BYE_DAD    0x20
#define FLAG_SAID_BYE_MOM    0x21
#define FLAG_RECEIVED_POTION_ROUTE1    0x22
...
#define FLAG_SYS_TRAINERID_GET                      (SYSTEM_FLAGS + 0x21) // Unused Flag
#define FLAG_SYS_NO_COLLISION                       (SYSTEM_FLAGS + 0x22)
#define FLAG_SYS_NO_ENCOUNTER                       (SYSTEM_FLAGS + 0x23)
#define FLAG_SYS_NO_TRAINER_SEE                     (SYSTEM_FLAGS + 0x24)
#define FLAG_SYS_NO_BAG_USE                         (SYSTEM_FLAGS + 0x25)
#define FLAG_SYS_NO_CATCHING                        (SYSTEM_FLAGS + 0x26)
#define FLAG_SYS_PC_FROM_DEBUG_MENU                 (SYSTEM_FLAGS + 0x27)
