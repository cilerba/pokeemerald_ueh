static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_LUMBRIDGE_TOWN - 1] = {MAP_GROUP(LUMBRIDGE_TOWN), MAP_NUM(LUMBRIDGE_TOWN), 7, 9},
    [HEAL_LOCATION_LUMBRIDGE_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(LUMBRIDGE_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(LUMBRIDGE_TOWN_PLAYERS_HOUSE_2F), 4, 5},
    [HEAL_LOCATION_IRENIA_TOWN - 1] = {MAP_GROUP(IRENIA_TOWN), MAP_NUM(IRENIA_TOWN), 4, 14},
};
