...
const u32 gItemIcon_Parcel[] = INCBIN_U32("graphics/items/icons/oaks_parcel.4bpp.lz");
const u32 gItemIconPalette_Parcel[] = INCBIN_U32("graphics/items/icon_palettes/oaks_parcel.gbapal.lz");
