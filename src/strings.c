...
const u8 gText_CraftQuantityHave[] = _("{STR_VAR_2}");
const u8 gText_CraftQuantityNeed[] = _("{STR_VAR_3}");
const u8 gText_CraftWhat[] = _("What would you like to craft?");
const u8 gText_CraftFail[] = _("Not enough materials.");
const u8 gText_CraftSuccess[] = _("Successfully crafted\n{STR_VAR_1}!");
const u8 gText_CraftConfirm[] = _("Craft {STR_VAR_2}?");
const u8 gText_CraftCancel[] = _("Give up crafting?");
